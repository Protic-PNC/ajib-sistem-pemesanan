    ...
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            <button data-drawer-target="drawer-navigation" data-drawer-toggle="drawer-navigation"
                ...
                class="p-1 md:p-2 mr-2 text-gray-600 rounded-md md:rounded-lg cursor-pointer md:hidden hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100">
                <x-phosphor-list class="w-5 h-5 md:w-6 md:h-6" />
                <span class="sr-only">Toggle sidebar</span>
            </button>
            <a href="/" class="flex items-center justify-between mr-4">
                <span
                    class="self-center md:text-2xl text-xl font-semibold whitespace-nowrap">Pemesanan</span>
            </a>
        ...
        <div class="flex items-center lg:order-2">
            ...
            <button type="button" data-dropdown-toggle="notification-dropdown"
                class="md:p-2 p-1 mr-1 text-gray-500 rounded-md md:rounded-lg hover:text-gray-900 hover:bg-gray-100 focus:ring-4 focus:ring-gray-300">
            ...
            <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg rounded-xl"
                ...
                <div>
                    <a href="#"
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <div
                                class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 rounded-full border border-white bg-primary-700 text-white">
                ...
                <a href="#"
                    ...
                    <div class="inline-flex items-center">
                        <x-phosphor-eye-fill class="mr-2 w-4 h-4 text-gray-500" />
                        Lihat semua
                    </div>
                </a>
            </div>
            ...
            <button type="button" data-dropdown-toggle="apps-dropdown"
                class="p-1 md:p-2 text-gray-500 rounded-md md:rounded-lg hover:text-gray-900 hover:bg-gray-100 focus:ring-4 focus:ring-gray-300">
                <span class="sr-only">View notifications</span>
                <!-- Icon -->
            ...
            <button type="button"
                class="flex md:mx-3 ml-2 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300"
            ...
            <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow rounded-xl"
                ...
                <ul class="py-1 text-gray-700" aria-labelledby="dropdown">
                    <li>
                        <a href="#"
                            class="block py-2 px-4 text-sm hover:bg-gray-100 flex">
